...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var becameInactiveAt:NSTimeInterval!
    
    func beginApp () {
        self.navctrl = UINavigationController(rootViewController: loginview)
        navctrl?.navigationBar.tintColor = UIColor.blackColor()
    ...
    func applicationDidBecomeActive(application: UIApplication) {
        ...
        if((NSDate.timeIntervalSinceReferenceDate() - becameInactiveAt) > 300 && raxutils.getPasswordFromKeychain() != nil) {
            raxutils.confirmDialog("Refresh session please",
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("rackyview", withExtension: "momd")
