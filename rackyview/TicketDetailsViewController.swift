...
class TicketDetailsViewController: UIViewController {
    ...
    func refresh() {
        ...
        NSOperationQueue().addOperationWithBlock {
            ...
            self.initState((try! NSJSONSerialization.JSONObjectWithData(ticketdetails, options: [])) as! NSDictionary)
    ...
    func viewComment(index:Int) {
        NSOperationQueue.mainQueue().addOperationWithBlock {
            raxutils.flashView(self.textview.viewForLastBaselineLayout, myDuration:0.4, myColor: UIColor(red: 0.2, green: 0, blue: 0.4, alpha: 1))
